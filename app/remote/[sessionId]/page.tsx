      ...
      <div className="grid grid-cols-2 gap-3 w-full max-w-xs">
        {buttons.map((b) => (
          <button
            key={b.label}
            onClick={b.action}
            className="bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg p-4 text-sm font-medium text-neutral-800 dark:text-neutral-200 active:bg-neutral-100 dark:active:bg-neutral-700 transition-colors shadow-sm"
          >
            {b.label}
          </button>
        ))}
